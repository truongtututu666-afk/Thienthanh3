-- Angel Transform Script với UI Skills góc phải
...
print("✅ Angel Transform Loaded!")
print("👼 Press button to transform!")
print("⌨️ Use Q,E,R,F,X,C for skills or tap buttons on mobile!")
